...
var latestPackages = new Set([].concat(_toConsumableArray(Object.values(packages)), ["@babel/runtime-corejs2"]));
...
stagePresets[2] = [].concat(_toConsumableArray(stagePresets[3]), [["@babel/plugin-proposal-decorators", {
  "legacy": true
...
stagePresets[0] = [].concat(_toConsumableArray(stagePresets[1]), ["@babel/plugin-proposal-function-bind"]);
module.exports = {
  packages,
  presets,
  plugins,
